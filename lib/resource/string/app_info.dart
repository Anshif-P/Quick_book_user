class AppInfo {
  static String about =
      'Welcome to QuickBook, your go-to destination for hassle-free hotel booking and unforgettable stays!';
  static String ourMission =
      'At QuickBook, we are on a mission to simplify your travel experience. We understand the importance of finding the perfect accommodation, and we\'re here to make that process easy, enjoyable, and efficient.';
  ...
  static String freeToUser =
      ' QuickBook is completely free for users, making it accessible to all travel enthusiasts';
